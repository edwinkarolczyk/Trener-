...
- Pełna kopia eksportowa i automatyczna przed aktualizacją obejmują również `trainer3.photos` oraz natywną historię wody ze wszystkich zapisanych dat. Limit kopii przed aktualizacją podwyższono do 32 MB; gdy pełna kopia jest zbyt duża, automatyczna aktualizacja pozostaje zatrzymana.
