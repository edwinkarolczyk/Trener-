...
const java=fs.readFileSync('app/src/main/java/pl/edwin/trener2/WaterWidgetProvider.java','utf8');
const receiver=fs.readFileSync('app/src/main/java/pl/edwin/trener2/HydrationReceiver.java','utf8');
const xml=fs.readFileSync('app/src/main/res/layout/water_widget.xml','utf8');
assert.match(java,/R\.id\.waterWidget100,add100/);
